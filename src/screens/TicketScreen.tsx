...
import { Text, View, StyleSheet, StatusBar, ImageBackground, Image, ScrollView } from 'react-native';
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                console.log("Something went wrong while getting Data from", error)
            }
        })()
    }, []);
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.ticketContainer}>
                <ImageBackground
                    ...
                    <LinearGradient colors={[COLORS.OrangeRGBA0, COLORS.Orange]}
                ...
                <View style={styles.ticketFooter}>
                    ...
                    <View style={styles.titleSeatContainer}>
                        <View style={styles.subtitleContainer}>
                            ...
                            <Text style={styles.subtitle}>{ticketData?.movieIndex}</Text>
                        </View>
                        <View style={styles.subtitleContainer}>
                            <Text style={styles.subheading}>Row</Text>
                            <Text style={styles.subtitle}>{ticketData?.row}</Text>
                        </View>
                        <View style={styles.subtitleContainer}>
                            <Text style={styles.subheading}>Seats</Text>
                            <Text style={styles.subtitle}>
                                {ticketData?.seatArray.slice(0, 4)
